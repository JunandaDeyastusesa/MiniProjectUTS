...
@section('content')
    <div class="form-tambah container">
        ...
        <form action="{{ route('barangs.store') }}" method="POST" class="row g-3 pt-3">
            @csrf
            <div class="col-md-6">
                <label for="kode_barang" class="form-label">Kode Barang</label>
                <input type="text" class="form-control" name="kode_barang" id="kode_barang" placeholder="R0001" required>
            </div>

            <div class="col-md-6">
                <label for="nama_barang" class="form-label">Nama Barang</label>
                <input type="text" class="form-control" name="nama_barang" id="nama_barang" placeholder="Roti Bantal..."
                    required>
            </div>
